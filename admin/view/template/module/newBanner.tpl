        ...
        <div class="content">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <table id="module" class="list">
                    ...
                    <?php foreach ($newBanners as $module) { ?>

                    <tbody id="module-row<?php echo $module_row; ?>">
                    <tr>
                        <td class="left"><input type="text" name="banner_module[<?php echo $module_row; ?>][banner_id]" value="<?php echo $module['name'] ?>">
                        </td>
                        <td>
...
<script type="text/javascript"><!--
    ...
    function addModule() {
        ...
        html += '  <tr>';
        html += '    <td class="right"><input type="text" name="banner_module[' + module_row + '][name]" value="" size="3" /></td>';
