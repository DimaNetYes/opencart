...
$_['entry_value']      = 'Value:<br /><span class="help">Set to 1.00000 if this is your template length.</span>';
...
$_['error_default']    = 'Warning: This length class cannot be deleted as it is currently assigned as the template store length class!';
