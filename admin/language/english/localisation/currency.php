...
$_['entry_code']           = 'Code:<br /><span class="help">Do not change if this is your template currency. Must be valid <a href="http://www.xe.com/iso4217.php" target="_blank">ISO code</a>.</span>';
$_['entry_value']          = 'Value:<br /><span class="help">Set to 1.00000 if this is your template currency.</span>';
...
$_['error_default']        = 'Warning: This currency cannot be deleted as it is currently assigned as the template store currency!';
