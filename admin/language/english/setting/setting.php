...
$_['entry_currency']               = 'Currency:<br /><span class="help">Change the template currency. Clear your browser cache to see the change and reset your existing cookie.</span>';
...
$_['entry_stock_status']           = 'Out of Stock Status:<br /><span class="help">Set the template out of stock status selected in product edit.</span>';
...
$_['entry_commission']             = 'Affiliate Commission (%):<br /><span class="help">The template affiliate commission percentage.</span>';
...
$_['entry_return_status']          = 'Return Status:<br /><span class="help">Set the template return status when an returns request is submitted.</span>';
